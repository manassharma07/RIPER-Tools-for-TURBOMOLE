...
energy_shift =  -0.166225#-0.088521#-0.094143#-0.035363#-0.09
# Num k-points for each band
num_k_points = 240
# K-point labels
kpoint_labels_plot = ['Γ', 'X', 'S', 'Y', 'Γ', 'S']
kpoint_ticks = [0.0000000, 0.5185097444, 0.7989535222, 1.3243132321, 1.6047570099, 2.1948914340]
