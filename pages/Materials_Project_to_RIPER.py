...
if docs is not None:
    ...
    col1.download_button('Download Primitive Unit Cell CIF', read_file("primitive_unit_cell.cif"), "primitive_unit_cell.cif", file_name='primitive_unit_cell.cif', key='primitive_cif_button')

    convert_to_cif(conventional_structure, "conventional_unit_cell.cif")
    col2.download_button('Download Conventional Unit Cell CIF', read_file("conventional_unit_cell.cif"), "conventional_unit_cell.cif", file_name='conventional_unit_cell.cif', key='conventional_cif_button')
